...
public class HotGingerMilkItem extends Item {
	public HotGingerMilkItem() {
		super(new Item.Properties().tab(ChristmasModTabs.TAB_INFOY_CHRISTMAS).stacksTo(1).rarity(Rarity.COMMON)
				.food((new FoodProperties.Builder()).nutrition(9).saturationMod(0.8f).alwaysEat()
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		HotGingerMilkPlayerFinishesUsingItemProcedure
